          ...
          <el-tab-pane label="手机登录" name="tabOne" :class="$style.tabOne">
            ...
            <el-form :model="formOne" label-width="0" :rules="formOneRules">
              ...
              <el-form-item prop="codeRule">
                <div>
                  <el-input v-model="formOne.messageCode" :class="$style.commonInput" placeholder="请输入短信验证码" />
                </div>
                <div>
          ...
          <el-tab-pane label="密码登录" name="tabTwo" :class="$style.tabTwo">
            ...
            <el-form :model="formOne" label-width="0" :rules="formOneRules">
              ...
              <el-form-item prop="usernameRule">
                <el-input v-model="formOne.username" :class="$style.commonInput" placeholder="请输入手机号/账号/用户名" />
              </el-form-item>
    ...
    <div v-else-if="registerContrll" :class="$style.registerBox">
      ...
      <div v-if="registerIndex === 1" :class="$style.registerOne">
        <el-form label-width="0">
          ...
          <el-button type="primary" :class="$style.commonButton" :disabled="!formTwo.check" @click="switchRegister(3)">
            下一步
          </el-button>
        </el-form>
      ...
      <div v-if="registerIndex === 3" :class="$style.registerThree">
        <el-form :rules="formTwoRules" v-model="formTwo" ref="formTwo" status-icon>
          ...
          <el-form-item prop="passRule">
            <el-input v-model="formTwo.password" :class="$style.commonInput" placeholder="设置密码" :show-password="true" />
          </el-form-item>
